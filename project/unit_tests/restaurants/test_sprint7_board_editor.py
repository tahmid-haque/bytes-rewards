...
def get_board():
    ...
    return {
        "name": "A Random Board",
        "size": 3,
        "expiry_date": "05/26/2021",
        "board": [
            "5ef50183ccd1e88ead4cd081",
            "5ef501f1ccd1e88ead4cd089",
            "5ef5010fccd1e88ead4cd079",
            "5ef50134ccd1e88ead4cd07c",
            "5ef50183ccd1e88ead4cd081",
            "5ef501b9ccd1e88ead4cd084",
            "5ef500edccd1e88ead4cd078",
            "5ef50155ccd1e88ead4cd07e",
            "5ef500edccd1e88ead4cd078"
        ],
        "board_reward": [
            "5f03aa287aae4a086d810105",
            "5f03a9fd7aae4a086d810102",
            "5f03aa377aae4a086d810106",
            "5f03a9df7aae4a086d810100",
            "5f03aa507aae4a086d810108",
            "5f03aa377aae4a086d810106",
            "5f03a9df7aae4a086d810100",
            "5f03aa507aae4a086d810108"
        ]
...
def get_database_board():
    ...
    return {
        "name": "A Random Board",
        "size": 3,
        "expiry_date": datetime(2021, 5, 26, 23, 59, 59),
        "board": [
...
def test_set_bingo_board_new_user(db):
    ...
    with app.app_context():
        ...
        db.update(
            "restaurant_users", 
            {"username": "newuser"}, 
            {"$unset": {"bingo_board": "", "future_board": ""}}
        )
...
def test_set_bingo_board_old_user(db):
    ...
    """
    with app.app_context():
        prev_user = db.query("restaurant_users", {"username": "boardeditoruser"})[0]
...
def test_get_future_board_old_user():
    ...
    with app.app_context():
        ...
        assert rpm.get_future_board() == {
            "name" : "My 3x3",
            "size" : 3,
            "expiry_date" : datetime(2020, 11, 27, 23, 59, 59),
            "board" : [
                    ObjectId("5ef50183ccd1e88ead4cd081"),
                    ObjectId("5ef501f1ccd1e88ead4cd089"),
                    ObjectId("5ef5010fccd1e88ead4cd079"),
...
def test_get_current_expiry_old_user():
    ...
    with app.app_context():
        rpm = RestaurantProfileManager("boardeditoruser")
        assert rpm.get_current_board_expiry() == datetime(2020, 11, 23, 23, 59, 59)

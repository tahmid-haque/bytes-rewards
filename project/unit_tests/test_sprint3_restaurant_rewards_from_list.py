...
def test_get_shared_rewards():
    ...
    expected_shared = [{'_id': ObjectId("5f03a9967aae4a086d8100fd"),
                       ...
                       {'_id': ObjectId("5f03aa1a7aae4a086d810104"),
	                    'reward': "Free dessert"},					   
                       {'_id': ObjectId("5f03aa287aae4a086d810105"),
	                    'reward': "Buy one entree, get another 50% off (of lesser or equal value)"},					   
...
def test_get_rewards_old_user():
    ...
    expected_rewards = [{'_id': ObjectId("5f03a9967aae4a086d8100fd"),
	                    'reward': "10% off a purchase"}, 
                       {'_id': ObjectId("5f03a9b57aae4a086d8100fe"),
	                    'reward': "15% off a purchase"}, 				   
                       {'_id': ObjectId("5f03a9c87aae4a086d8100ff"),
...
def test_get_rewards_from_board():
    ...
    expected_rewards = [ObjectId('5f03a9967aae4a086d8100fd'), 
...
def test_set_board_rewards():
    ...
    new_rewards = [ObjectId('5ef50127ccd1e88ead4cd07b'),
